...
DiGraphReader.java - The start of an implementation of IGraphReader, and creates a visual representation of the graph
graphfile.cs2 - A sample graph file containing 3 nodes and 3 edges
Edge.java - Creates a path between two Node type objects
Node.java - Creates a node
Graph.java - Creates a graph that manages nodes and edges
